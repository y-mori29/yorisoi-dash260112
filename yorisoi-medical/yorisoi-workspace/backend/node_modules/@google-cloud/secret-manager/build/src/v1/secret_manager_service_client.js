...
class SecretManagerServiceClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('secret-manager');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    initialize() {
        ...
        this.secretManagerServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.cloud.secretmanager.v1.SecretManagerService, this._opts, this._providedCustomServicePath);
