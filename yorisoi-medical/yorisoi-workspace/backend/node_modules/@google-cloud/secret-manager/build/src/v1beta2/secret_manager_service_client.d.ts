...
export declare class SecretManagerServiceClient {
    ...
    */
     ...
     * @returns {string} Resource name string.
     */
    projectLocationSecretsPath(project: string, location: string, secret: string): string;
    /**
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectLocationSecretsName(projectLocationSecretsName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromProjectLocationSecretsName(projectLocationSecretsName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the secret.
     */
    matchSecretFromProjectLocationSecretsName(projectLocationSecretsName: string): string | number;
    /**
     ...
     * @returns {string} Resource name string.
     */
    projectSecretsPath(project: string, secret: string): string;
    /**
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectSecretsName(projectSecretsName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the secret.
     */
    matchSecretFromProjectSecretsName(projectSecretsName: string): string | number;
    /**
